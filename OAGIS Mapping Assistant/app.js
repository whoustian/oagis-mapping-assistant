...
// When deployed, port/5000 is replaced with the proxy path to the backend.
// Locally (dev), it stays as port/5000 — so we fall back to same-origin.
const __API_BASE = 'port/5000';
